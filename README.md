...
- [InfinityMetrics](https://getinfinitymetrics.com) - A self-hosted analytics server with an embedded SQLite database, no third-party sharing. Explore your data beyond the limits of the dashboard with plain English questions.
